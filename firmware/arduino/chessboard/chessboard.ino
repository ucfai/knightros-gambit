...
#define POS_X_AXIS_ENDSTOP_SWITCH 18
#define POS_Y_AXIS_ENDSTOP_SWITCH 19
#define NEG_X_AXIS_ENDSTOP_SWITCH 34
#define NEG_Y_AXIS_ENDSTOP_SWITCH 35
...
uint8_t xMotor[6] = {X_MOTOR_STEP, X_MOTOR_DIR, X_MOTOR_MS1, X_MOTOR_MS2, POS_X_AXIS_ENDSTOP_SWITCH, NEG_X_AXIS_ENDSTOP_SWITCH};
...
uint8_t yMotor[6] = {Y_MOTOR_STEP, Y_MOTOR_DIR, Y_MOTOR_MS1, Y_MOTOR_MS2, POS_Y_AXIS_ENDSTOP_SWITCH, NEG_Y_AXIS_ENDSTOP_SWITCH};
...
void setup()
{
  ...
  pinMode(POS_X_AXIS_ENDSTOP_SWITCH, INPUT);
  pinMode(POS_Y_AXIS_ENDSTOP_SWITCH, INPUT);
  pinMode(NEG_X_AXIS_ENDSTOP_SWITCH, INPUT);
  pinMode(NEG_Y_AXIS_ENDSTOP_SWITCH, INPUT);
