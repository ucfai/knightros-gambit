...
class Board(dict):
    ...
    def alpha_notation(self, xycoord):
        '''Returns x,y coordinates in numbers and letters (e.g., "e6") of position on chessboard.
        '''
    ...
    def show(self, pat):
            '''Prints a visual representation of the board state based on a fen string.
            '''
            self.clear()
